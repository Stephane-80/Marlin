...
#define DIGIPOT_I2C_MOTOR_CURRENTS { 0.8, 0.8, 0.8, 0.8, 0.8 }  //  MKS SBASE: 5
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_DELAY       5000  // (ms) Delay for the filament to cool after retract.  #define FILAMENT_UNLOAD_PURGE_LENGTH         0  // (mm) An unretract is done, then this length is purged.
